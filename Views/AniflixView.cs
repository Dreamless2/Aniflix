    ...
    public partial class AniflixView : UIForm
    {
        ...
        private static (Color background, Color accent) SelectThemeColors()
        {
            ...
            [
                ...
                Color.FromArgb(23, 86, 111),    // #17566F - Azul safira
                Color.FromArgb(255, 87, 34),    // #FF5722 - Laranja avermelhado
                Color.FromArgb(51, 111, 145),   // #336F91 - Azul petroleo claro
                ...
                Color.FromArgb(57, 97, 83),     // #396553 - Jumbo
        ...
        {
            ActivateButton(sender, GlobalFunctions.RGBColors.color1);
